...
<Gallery cols={2} fixedHeight>
    <GalleryImage src="img/v2/examples/dead_cells/rooftop/outteleport1.png" caption="Inside room" />
    <GalleryImage src="img/v2/examples/dead_cells/rooftop/outteleport2.png" caption="Inside room" />
</Gallery>
