...
namespace Assets.ProceduralLevelGenerator.Scripts.GeneratorPipeline.RoomTemplates
{
	...
	public class RoomInstance
	{
        ...
        public RoomInstance(Room room, Connection connection, GameObject roomTemplatePrefab, GameObject roomTemplateInstance, Vector3Int position, IRoom<Room> generatorData, bool isCorridor)
        {
            Room = room;
